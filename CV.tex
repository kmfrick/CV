...
\section*{Languages and nationality}
 ...
 \textbf{Italian} (native), \textbf{English} (bilingual, IELTS 8.5),
  \textbf{Spanish} (fluent), \textbf{French} (intermediate). \textbf{German} and \textbf{Italian} national.
...
TSE \emph{École Universitaire de Recherche} (EUR) Scholarship \hfill 2022 - 2023
