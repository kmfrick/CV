...
\begin{cvlist}{}
  \itemsep -5pt
	\item[07/2023 - 08/2023]
		...
		Supervisors: Luc Behaghel, Artur Obminski
	\item[10/2021 - 07/2022]
    \textbf{Paris School of Economics / DARES}\\
		Position: Research assistant\\
		Supervisors: Thomas Zuber, Yagan Hazard, Damien Mayaux
	\item[03/2020 - 07/2020]
		\textbf{University of Twente}\\
		Position: Research intern\\
		Supervisos: Stefano Stramigioli, Davide Bicego, Santiago Sanchez-Escalonilla
\end{cvlist}
\vspace{-24pt}
  \section*{Teaching}
  \begin{cvlist}{}
